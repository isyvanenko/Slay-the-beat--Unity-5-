...
public class MenuSelector : MonoBehaviour
{
    ...
    /// <summary>
    /// Public method to reset the selector state (called when menu is reactivated)
    /// </summary>
    ...
    /// <summary>
    /// Set the current selected index from external script
    /// </summary>
    public void SetCurrentIndex(int newIndex)
    {
        if (!isFading && !hasSelected && newIndex >= 0 && newIndex < buttons.Length)
        {
            index = newIndex;
            UpdateSelectionText();
        }
    ...
    /// <summary>
    /// Check if menu is available for selection
    /// </summary>
    public bool IsAvailableForSelection()
    {
        return !isFading && !hasSelected;
    }
    ...
    private void UpdateSelectionText()
    {
        ...
        if (selectionTexts != null && index < selectionTexts.Length)
        {
